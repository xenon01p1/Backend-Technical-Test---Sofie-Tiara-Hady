...
export const createPurchaseRequest = async (
  ...
  try {
    ...
    logRequest(
      ...
      '/purchase-requests',
      true,
      `Created Purchase Request id=${purchaseRequest.id}`,
      startTime
    );
...
export const getPurchaseRequests = async (
  ...
  try {
    ...
    const result =
      await purchaseRequestService.getPurchaseRequests(filter);

    logRequest(
      'GET',
      '/purchase-requests',
      true,
      `Retrieved Purchase Requests records=${result.data.length}`,
      startTime
    );
...
export const getPurchaseRequestById = async (
  ...
  try {
    ...
    logRequest(
      ...
      true,
      `Retrieved Purchase Request id=${id}`,
      startTime
    );
...
export const updatePurchaseRequest = async (
  ...
  try {
    ...
    logRequest(
      ...
      '/purchase-requests/:id',
      true,
      `Updated Purchase Request id=${id}`,
      startTime
    );
...
export const submitPurchaseRequest = async (
  ...
  try {
    ...
    logRequest(
      ...
      true,
      `Submitted Purchase Request id=${id}`,
      startTime
    );
...
export const approvePurchaseRequest = async (
  ...
  try {
    ...
    logRequest(
      ...
      true,
      `Approved Purchase Request id=${id}`,
      startTime
    );
...
export const rejectPurchaseRequest = async (
  ...
  try {
    ...
    logRequest(
      ...
      true,
      `Rejected Purchase Request id=${id}`,
      startTime
    );
