...
export const getPurchaseOrders = async (
  ...
  try {
    ...
    logRequest(
      ...
      '/purchase-orders',
      true,
      `Retrieved purchase orders records=${result.data.length}`,
      startTime
    );
...
export const getPurchaseOrderById = async (
  ...
  try {
    ...
    logRequest(
      ...
      `/purchase-orders/${id}`,
      true,
      `Retrieved purchase order id=${id}`,
      startTime
    );
...
export const markPurchaseOrderAsOrdered = async (
  ...
  try {
    ...
    const purchaseOrder =
      await purchaseOrderService.markPurchaseOrderAsOrdered(
        id,
        userId
      );
    ...
    logRequest(
      ...
      true,
      `Marked purchase order id=${id} as ORDERED`,
      startTime
    );
    ...
    logRequest(
      'POST',
      `/purchase-orders/${req.params.id}/order`,
      false,
