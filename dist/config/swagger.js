export const swaggerSpec = {
    ...
    info: {
        ...
        version: '1.0.0',
        description: 'Backend API for inventory and procurement management.',
    },
    servers: [
        {
    ...
    components: {
        ...
        schemas: {
            ...
            GoodsReceipt: {
                ...
                properties: {
                    purchase_order_id: { type: 'integer', example: 1 },
                    items: {
                        type: 'array',
                        items: {
                            type: 'object',
    ...
    paths: {
        ...
        '/goods-receipts': {
            post: {
                ...
                responses: {
                    '201': {
                        description: 'Goods Receipt created and inventory updated.',
                    },
                    '400': {
                        description: 'Invalid receipt quantity or Purchase Order status.',
                    },
                },
            },
        },
