...
export const createPurchaseRequest = async (requestNumber, requestedBy, data) => {
...
export const getPurchaseRequestsByCursor = async (filter) => {
    const conditions = [];
    const values = [];
...
export const updatePurchaseRequestStatus = async (id, status, approvedBy) => {
